...
const Homescreen = () => {
  ...
  // URL
  const getWeather = () => {
    const url = `https://api.openweathermap.org/data/2.5/forecast/daily?lat=${coords.lat}&lon=${coords.long}&mode=json&units=metric&cnt=5&appid=7e4d91d900116b12a167ca50980fd109`;
